...
if __name__ == '__main__':
    ...
    mesh_sphere = Mesh(filename='./obj/simple_2face.obj', color=[1.0, 0.4, 0.2], rescale=0.2, translation=[0, -10, 0])
    # mesh_cloth = Mesh(filename='./obj/simple_2face_vertical.obj', color=[0.5, 0.5, 0.5], rescale=0.1, translation=[0, 1.0, 0])
    mesh_cloth = Mesh(filename='./obj/simple_4face_horizontal_vertical.obj', color=[0.5, 0.5, 0.5], rescale=0.1, translation=[0, 1.0, 0])
