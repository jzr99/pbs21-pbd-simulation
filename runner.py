...
if __name__ == '__main__':
    ...
    mesh_cloth = Mesh(filename='./obj/cloth.obj', color=[0.5, 0.5, 0.5], rescale=0.15, translation=[0, 1.0, 0])
    ...
    sim = Simulation(module, render, max_run_step=2500, render_step=render_step)
