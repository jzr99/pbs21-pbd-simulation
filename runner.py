...
if __name__ == '__main__':
    ...
    # mesh_cloth = Mesh(filename='./obj/cloth_large_new.obj', color=[0.2, 0.2, 0.2], rescale=0.6, translation=[0, 1.1, -0.28], reverse_triangle_verts=True)
    # mesh_sphere = Mesh(filename='./obj/sphere.obj', color=[1.0, 0.4, 0.2], rescale=0.1, translation=[0, 0.7, 0])
    mesh_cloth = Mesh(filename='./obj/cloth.obj', color=[1.0, 0.4, 0.2], rescale=0.2, translation=[0, 1.0, 0])
    ...
    sim = Simulation(module, render, max_run_step=460)
